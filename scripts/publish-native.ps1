...
Get-Process -Name "MacMount.NativeBroker","MacMount.NativeService","MacMount.UserSessionHelper" -ErrorAction SilentlyContinue | ForEach-Object {
...
Write-Host "Publishing MacMount.UserSessionHelper..."
...
$userSessionExe = Join-Path $outDir "user-session\MacMount.UserSessionHelper.exe"
