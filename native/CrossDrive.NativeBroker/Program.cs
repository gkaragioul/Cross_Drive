...
internal sealed class BrokerPassthroughFileSystem : FileSystemBase
{
    ...
    public BrokerPassthroughFileSystem(string rootPath, long totalBytes = 0, long freeBytes = 0)
    {
        ...
        _enableMetadataCache =
            !isUncBacked ||
            EnvIsEnabled("CROSSDRIVE_ENABLE_UNC_METADATA_CACHE", "CROSSDRIVE_ENABLE_UNC_METADATA_CACHE");
        _enableLocalMirrorCache =
            EnvIsEnabled("CROSSDRIVE_ENABLE_LOCAL_MIRROR_CACHE", "CROSSDRIVE_ENABLE_LOCAL_MIRROR_CACHE") &&
            !isUncBacked;
        _enableAggressivePrefetch =
            EnvIsEnabled("CROSSDRIVE_ENABLE_AGGRESSIVE_PREFETCH", "CROSSDRIVE_ENABLE_AGGRESSIVE_PREFETCH");
